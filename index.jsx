    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-black text-white">
      <div className="max-w-4xl w-full text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          ...
          <br />
          <span className="text-gray-400 text-2xl">Poker bonussen voor Nederlandse spelers</span>
        </h1>

        <p className="text-lg md:text-xl mb-10">
          Compare the best welcome bonuses from licensed online poker sites. <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="border border-gray-700 p-6 rounded-xl bg-gray-900">
            <h2 className="text-2xl font-bold mb-2">GGPoker</h2>
